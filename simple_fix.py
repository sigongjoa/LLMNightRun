...
app = FastAPI(title="로컬 LLM API 서버")
...
async def root():
    ...
    return {"message": "LLM API 서버가 실행 중입니다."}
...
async def llm_ping():
    ...
    return {"status": "ok", "message": "LLM 서버가 응답 중입니다."}
...
async def llm_chat(request: Request):
    ...
    return {
        "content": "LM Studio 서버가 연결되지 않았습니다. 이것은 임시 응답입니다.",
        "model_id": "deepseek-r1-distill-qwen-7b"
    }

if __name__ == "__main__":
    print("LLM API 서버를 시작합니다...")
